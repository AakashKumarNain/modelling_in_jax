...
class Attention(ParamInitializer):
    ...
    def _param_specs(cls, cfg, d_emb, q_heads, kv_heads, head_dim):
        ...
        return Attention(
            d_emb=d_emb, q_heads=q_heads, kv_heads=kv_heads, head_dim=head_dim, wqkv=wqkv, wo=wo)

    @classmethod
    def init(cls, key, cfg, d_emb, q_heads, kv_heads, head_dim):
        return cls._init_fn(key, cfg, d_emb=d_emb, q_heads=q_heads, kv_heads=kv_heads, head_dim=head_dim,)
